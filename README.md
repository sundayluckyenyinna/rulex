...
| **ActionExcutor**     | (Typo: should be `ActionExecutor`) Executes a list of actions and returns execution results.                                   | `Map<String, List<String>> executeAll(List<Action>, EvaluationContext)` | `DefaultActionExecutor`                                                                                       |
