...
public class ActionTypeIdResolver implements TypeIdResolver {
    ...
    protected static Map<String, Class<? extends Action>> ACTION_TO_CLASS_REGISTRY = new HashMap<>();
    ...
    public String idFromValueAndType(Object o, Class<?> aClass) {
        return ACTION_TO_CLASS_REGISTRY.entrySet().stream()
    ...
    public JavaType typeFromId(DatabindContext databindContext, String id) throws IOException {
        Class<? extends Action> conditionClass = ACTION_TO_CLASS_REGISTRY.entrySet().stream()
